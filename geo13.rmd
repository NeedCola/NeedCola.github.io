...
# [Tesselations, Point-in-Polygon](https://needcola.github.io/giswork/lab-04.html)
...
In the **GIS Work 02**, terrain analysis is managed by R coding. Mission Creek's flood event in 2017 in Santa Barbara, California has been chosen as object, estimating the number of buildings impacted. In the project, I completed the whole analysis from collecting data to the assessment of impacts.

# [Flood Risk in Mission Creek: Past, Present, Future](https://needcola.github.io/giswork/lab-06.html)
